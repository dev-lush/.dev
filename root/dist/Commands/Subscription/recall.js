import { SlashCommandBuilder, MessageFlags, TextChannel, NewsChannel, InteractionContextType, ApplicationIntegrationType } from 'discord.js';
import { Subscription, SubscriptionType } from '../../Models/Subscription.js';
import { format } from 'date-fns';
import { commandGuard } from '../../Utils/commandGuard.js';
import { fetchIncidents, fetchIncidentById, buildStatusPayload, getStatusMentionPings } from '../../Utils/discordStatus.js';
...
export default {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('subscription')
    ...
    async execute(interaction) {
        ...
        if (subCommand === 'status') {
            try {
                ...
                const existingIncident = subscription.incidents.find((i) => i.incidentId === incidentId);
