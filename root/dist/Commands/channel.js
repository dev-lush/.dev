...
export const data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: 'Text Channel', value: String(ChannelType.GuildText) }, { name: 'Announcement Channel', value: String(ChannelType.GuildAnnouncement) }, { name: 'Forum Channel', value: String(ChannelType.GuildForum) }, { name: 'Media Channel', value: String(ChannelType.GuildMedia) }, { name: 'Voice Channel', value: String(ChannelType.GuildVoice) }, { name: 'Stage Channel', value: String(ChannelType.GuildStageVoice) }))
    .addStringOption((opt) => opt.setName('name').setDescription('The name of the channel').setRequired(true))
    .addStringOption((opt) => opt
    .setName('description')
    ...
    .setRequired(true)
    .addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement, ChannelType.GuildForum, ChannelType.GuildMedia, ChannelType.GuildVoice, ChannelType.GuildStageVoice, ChannelType.GuildCategory))
    .addStringOption((opt) => opt.setName('name').setDescription('The new name for the channel (optional)'))
    .addStringOption((opt) => opt.setName('description').setDescription('The new description/topic (optional)')));
