import { SlashCommandBuilder, MessageFlags, ApplicationIntegrationType, InteractionContextType, ContainerBuilder, TextDisplayBuilder } from 'discord.js';
...
const commandBuilder = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: 'Relative', value: 'relative' }, { name: 'Long Date/Time', value: 'longDate_dayofWeek_shortTime' }, { name: 'Short Date/Time', value: 'longDate_ShortTime' }, { name: 'Long Date', value: 'longDate' }, { name: 'Short Date', value: 'shortDate' }, { name: 'Long Time', value: 'longTime' }, { name: 'Short Time', value: 'shortTime' }))
    ...
    async execute(interaction) {
        ...
        if (errors.length > 0) {
            ...
            const container = new ContainerBuilder()
                .addTextDisplayComponents(new TextDisplayBuilder().setContent(`-# <:Events:1424617114597326878> </timestamp:1422972419206811709>\n${exampleContent}`));
