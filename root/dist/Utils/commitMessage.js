import { NewsChannel, TextChannel, PermissionFlagsBits } from 'discord.js';
import { Subscription } from '../Models/Subscription.js';
import { RoleMentionsHandler } from '../Models/RoleMentionsHandler.js';
export function buildCommitCommentMessage(options) {
...
async function getRoleMentionsForGuild(guildId, type) {
...
export async function checkNewCommitComments(client) {
    ...
    const comments = await fetch(commitDetails.comments_url).then(res => res.json());
