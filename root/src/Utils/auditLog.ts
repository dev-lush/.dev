 ...
 */
export function buildAuditLogReasonPlain(userId: string, customReason?: string): string {
 ...
 */
export function buildAuditLogReasonHeaderValue(plain: string, limitBytes = AUDIT_LOG_REASON_LIMIT_BYTES): string {
  ...
  const fits = (candidateExtra: string) => {
 ...
 */
export function getAuditLogHeaders(userId: string, customReason?: string): Record<string, string> {
 ...
 */
export function headersFromInteraction(interaction: ChatInputCommandInteraction): Record<string, string> {
