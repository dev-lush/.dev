import { ChatInputCommandInteraction, SlashCommandBuilder, PermissionFlagsBits, ComponentType, RoleSelectMenuBuilder, ActionRowBuilder } from 'discord.js';
...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    collector.on('collect', async select => {
      ...
      await RoleMentionsHandler.findOneAndUpdate(
        { guildId: interaction.guildId, type: subscription, value: category },
        { roleId: role.id },
        { upsert: true }
      );
