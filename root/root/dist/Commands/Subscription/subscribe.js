import { SlashCommandBuilder, PermissionFlagsBits, TextChannel, NewsChannel, MessageFlags, InteractionContextType, ApplicationIntegrationType, ChannelType, } from 'discord.js';
...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'Discord Status', value: SubscriptionType.STATUS }, { name: 'Discord Previews', value: SubscriptionType.PREVIEWS }))
        .addChannelOption(option => option.setName('channel')
        .setDescription('The channel where updates will be sent.')
        .setRequired(false)
        .addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement))
        .addBooleanOption(option => option.setName('auto-publish')
