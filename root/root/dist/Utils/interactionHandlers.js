...
import { assetSuccessMessage, assetTooLargeMessage, genericErrorMessage, assetNotFoundMessage, serverNotFoundMessage, assetFetchFailedMessage } from '../System Messages/Commands/info/server.js';
const MAX_FILE_SIZE = 25 * 1024 * 1024; // 25 MB
export async function handleAssetButton(interaction) {
    try {
