import { ChatInputCommandInteraction, SlashCommandBuilder, PermissionFlagsBits, TextChannel, NewsChannel } from 'discord.js';
...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const channel = interaction.options.getChannel('channel', false) as TextChannel | NewsChannel | null;
    ...
    let sendChannel: TextChannel | NewsChannel;
    if (channel) {
